...
public class RSCSign {
	...
	public RSCSign(String name, int x, int y, int z, World world, int delay,
	...
	public boolean isON() {
		...
		return getTorchLocation().getBlock().getType() == Material.REDSTONE_TORCH;
	}
